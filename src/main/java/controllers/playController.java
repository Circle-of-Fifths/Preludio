...
public class playController {
    ...
    public void saveScore(String name, String score, String rating) {
        ...
        if (Preludio.getInstance().getUserName() != "User") {
            try {
                URL url = new URL("http://ec2-54-214-225-63.us-west-2.compute.amazonaws.com/extern_send_score.php");
                Map<String, Object> params = new HashMap<>();
                params.put("username", Preludio.getInstance().getUserName());
                ...
                if (response.equals("Valid")) {
                    System.out.println("Successfully sync'd score.");
                } else if (response.equals("Invalid")){
                    System.out.println("Couldn't successfully sync score.");
                }
            } catch (Exception mue) {
                mue.printStackTrace();
            }
